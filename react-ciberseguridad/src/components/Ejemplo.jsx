...
import { ChevronDownIcon, PhoneIcon, PlayCircleIcon , ShieldCheckIcon} from '@heroicons/react/20/solid';
import { PopoverGroup ,PopoverButton, Popover, PopoverPanel, Dialog, DialogPanel, Disclosure,DisclosureButton,DisclosurePanel
...
return (
    ...
    <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
            ...
            <div className ="flex lg:flex-1">
                ...
                < ShieldCheckIcon className="h-20 w-auto" />
                </Link>
            </div>
            ...
            <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                            ...
                            <Link to="/" className="text-sm/6 font-semibold text-gray-900">Inicio</Link>
                                    ...
                                    <div className="p-4">
                                        {services.map((service)=>(
                                            ...
                                            >
                                                ...
                                                <service.icon aria-hidden="true" className="size-6 text-gray-600 group-hover:text-indigo-600" />
                                                </div>
                                                <div className="flex-auto">
                                                    <Link to="/services" className="block font-semibold text-gray-900">
                                                    {service.name}
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
                <div className="fixed inset-0 z-10">
                    ...
                    <div className="mt-6 flow-root">
                        <Link to="/" className="block p-4 text-sm/6 font-semibold text-gray-900">
                        Inicio
                        </Link>
                        ...
                        <Link to="/contact" className="block p-4 text-sm/6 font-semibold text-gray-900">
                        Contacto
                        </Link>
                        <Link to="/blog" className="block p-4 text-sm/6 font-semibold text-gray-900">
                        Blog
                        </Link>
                    </div>
